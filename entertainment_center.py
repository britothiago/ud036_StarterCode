...
gaugin = media.Movie("GAUGUIN", "Vincent Cassel",
                    "Biography, Romance, Drama", "https://yifyddl.com/uploads/3ZXWgQDqn1RZDKR3.png", "https://www.youtube.com/watch?v=bvQ1wZvk0EI")

lovingpablo = media.Movie("LOVING PABLO", "Penelope Cruz, Javier Bardem, Peter Sarsgaard, Colin Salmon",
...
avengers = media.Movie("AVENGERS", "Scarlett Johansson, Chris Hemsworth, Chris Evans, Elizabeth Olsen",
