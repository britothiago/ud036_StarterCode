...
alpha = media.Movie("ALPHA",
                    "Morgan Freeman, Kodi Smit-McPhee, Leonor Varela, Natassia Malthe",
...
mile22 = media.Movie("MILE 22",
                     "Lauren Cohan, Mark Wahlberg, Ronda Rousey, John Malkovich",
...
themeg = media.Movie("THE MEG",
                     "Jason Statham, Ruby Rose, Rainn Wilson, Robert Taylor",
...
thebombing = media.Movie("THE BOMBING",
                         "Bruce Willis, Adrien Brody, Rumer Willis, Bingbing Fan",
...
listadeschindler = media.Movie("SCHINDLER'S LIST",
                               "Ralph Fiennes, Liam Neeson, Embeth Davidtz, Ben Kingsley",
                               "Biography, Action, History",
                               "https://yifyddl.com/uploads/pn5yfqF0Od3c8aZZ.png",
                               "https://www.youtube.com/watch?v=gG22XNhtnoY")

thepianist = media.Movie("THE PIANIST",
                         "Adrien Brody, Thomas Kretschmann, Emilia Fox, Ed Stoppard",
...
ateoultimohomem = media.Movie("HACKSAW RIDGE",
                              "Teresa Palmer, Luke Bracey, Sam Worthington, Hugo Weaving",
                              "History, Biography, War, Action",
                              "https://yifyddl.com/uploads/3LrFLi7YStMbIU4v.png",
...
lovingpablo = media.Movie("LOVING PABLO",
                          "Penelope Cruz, Javier Bardem, Peter Sarsgaard, Colin Salmon",
                          "Biography, Crime",
                          "https://yifyddl.com/uploads/QiC6zOmD3XefkeDB.png",
...
avengers = media.Movie("AVENGERS",
                       "Scarlett Johansson, Chris Hemsworth, Chris Evans, Elizabeth Olsen",
                       "Action",
                       "https://yifyddl.com/uploads/MVxdpxcdLZaC7Kd9.png",
                       "https://www.youtube.com/watch?v=tmeOjFno6Do")

'#Array com os filmes criados'
filmes = [alpha, mile22, theequalizer2, themeg, thebombing, thepianist, ateoultimohomem, gaugin, listadeschindler, nun, avengers, lovingpablo]
